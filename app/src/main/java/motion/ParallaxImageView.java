...
/**
 * Created by Schmänd on 25.05.2018.
 */
...
public class ParallaxImageView extends ImageView implements SensorEventListener {
    ...
    public ParallaxImageView(final Context context, AttributeSet attrs, int defStyle) {
    ...
    private void configureMatrix() {
        ...
        int dWidth = ContextCompat.getDrawable(getContext(), R.drawable.background).getIntrinsicWidth();
        int dHeight = ContextCompat.getDrawable(getContext(), R.drawable.background).getIntrinsicHeight();
        int vWidth = getWidth();
